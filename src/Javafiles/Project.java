...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("src/icons/elect7.jpg"));
        Image i3 = ic.getImage().getScaledInstance(1350, 650,Image.SCALE_DEFAULT);
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon2.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon3.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon5.png"));
        ...
        ImageIcon icon41 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon4.png"));
        ...
        ImageIcon icon42 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon6.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon4.png"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon6.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon7.png"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon12.png"));
        ...
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon9.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon10.png"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("src/icons/icon11.png"));
