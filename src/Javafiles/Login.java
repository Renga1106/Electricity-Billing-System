...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        ImageIcon ic1 = new ImageIcon(ClassLoader.getSystemResource("src/icons/login.png"));
        Image i1 = ic1.getImage().getScaledInstance(16, 16,Image.SCALE_DEFAULT);
        b1 = new JButton("Login", new ImageIcon(i1));
        b1.setBounds(330, 160, 100, 20);
        add(b1);

        ImageIcon ic2 = new ImageIcon(ClassLoader.getSystemResource("src/icons/cancel.jpg"));
        Image i2 = ic2.getImage().getScaledInstance(16, 16,Image.SCALE_DEFAULT);
        b2 = new JButton("Cancel",new ImageIcon(i2));
        b2.setBounds(450, 160, 100, 20);
        add(b2);

        ImageIcon ic4 = new ImageIcon(ClassLoader.getSystemResource("src/icons/signup.png"));
        ...
        ImageIcon ic3 = new ImageIcon(ClassLoader.getSystemResource("src/icons/second.jpg"));
